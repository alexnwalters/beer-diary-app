        ...
        return (
            <div className='LandingPage'>
                ...
                <div className='LandingPage_description'>
                    ...
                    <p className='raleway_lgt'>Search for a beers, our add ones of your choice. Review each beer by aroma, taste, color, drinkability, and even include personal notes.</p>
                    <p className='raleway_lgt'>Demo Username: Tester1<br/>Demo Password: Tester1!</p>
                </div>
                <div>
